...
def add_component():
    ...
    if request.method == 'POST':  # check to see if all data is filled in
        try:
            ...
            sql = "INSERT INTO components (component_id, material, category, weight, component_condition, availability, availability_date, component_owner, owner_email, location, price, component_description) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
